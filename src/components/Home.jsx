                    ...
                    <td className="p-4 flex justify-center gap-1">
                      <div>
                        <Link to={`/detail/${item.id}`}>
                          <button className="w-10 h-10 flex justify-center items-center border-2 border-primaryColor rounded-md cursor-pointer hover:bg-linear-to-br hover:from-[#018A85] hover:to-[#0C4259] text-primaryColor hover:text-white">
